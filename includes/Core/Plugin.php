...
class Plugin {
    ...
    public static function enqueue_frontend_assets(): void
    {
        ...
        wp_register_script('adoration-scheduler-frontend-flags', '', [], ADORATION_SCHEDULER_VERSION, true);
    ...
    public static function enqueue_admin_assets($hook_suffix): void
    {
        ...
        wp_register_script('adoration-scheduler-admin-flags', '', [], ADORATION_SCHEDULER_VERSION, true);
